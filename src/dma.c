...
void dma_setup_mem_copy(dma_channel *channel, void *dest, void *src, u32 length, u32 burst_length, u32 stride) {
    if (stride==0) {
        // Not 2d mode
        ...
        channel->block->mode_2d_stride = stride;
